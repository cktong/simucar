...
Model Name:         carrent1942
Model Description:  A DETERMINISTIC QUEUE (M/D/1) WITH BREAKDOWNS
Output File:        untitled.out
Output Plot Style:  NOAUTO_FIT
Run Mode:           HI_SPEED
Trace Vars:         L[1],L[2],L[3],L[4],L1[1],L1[2],L1[3],L1[4],L2[1],L2[2],L2[3],L2[4],SERVICED[1],SERVICED[2],SERVICED[3],SERVICED[4]
...
,(double)L[1], (double)L[2], (double)L[3], (double)L[4], (double)L1[1], (double)L1[2], (double)L1[3], (double)L1[4], (double)L2[1], (double)L2[2], (double)L2[3], (double)L2[4], (double)SERVICED[1], (double)SERVICED[2], (double)SERVICED[3], (double)SERVICED[4]);
}
