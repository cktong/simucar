...
event_trace(const char * name_of_event,const long count)
{
  ...
  c_timest(RUNC[2], 18, 0);
  c_sampst(RUNC[2], 18, 0);
  c_timest(RUNC[3], 19, 0);
  c_sampst(RUNC[3], 19, 0);
  c_timest(RUNC[4], 20, 0);
  c_sampst(RUNC[4], 20, 0);
  ...
  if(trace_flag) fprintf(output_fp, "	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g 	%7.10g	%7.10g 	%7.10g 	%7.10g 	%7.10g \n"
,(double)L[1], (double)L[2], (double)L[3], (double)L[4], (double)L1[1], (double)L1[2], (double)L1[3], (double)L1[4], (double)L2[1], (double)L2[2], (double)L2[3], (double)L2[4], (double)SERVICED[1], (double)SERVICED[2], (double)SERVICED[3], (double)SERVICED[4], (double)RUNC[1], (double)RUNC[2], (double)RUNC[3], (double)RUNC[4], (int)CUMCOST[1], (int)CUMCOST[2], (int)CUMCOST[3], (int)CUMCOST[4]);
}
...
run_end()
{
  ...
  c_sampst(RUNC[1], 17, 1);
   ...
   printf(" Minimum  = 	%7.4g\n", transfer[7]);
   printf(" Maximum  = 	%7.4g\n", transfer[6]);
  c_timest(RUNC[2], 18, 1);
   fprintf(output_fp, "RUNC[2]:\n Time Ave. = \t%7.4g Time Sample Var. =\t%7.4g\n", transfer[4], transfer[7]);
   printf("RUNC[2]:\n Time Ave. = 	%7.4g Time Sample Var. = 	%7.4g\n", transfer[4], transfer[7]);
  c_sampst(RUNC[2], 18, 1);
   fprintf(output_fp, " Event Ave. =\t%7.4g Event Sample Var. =\t%7.4g\n", transfer[4], transfer[8]);
   fprintf(output_fp, " Minimum =\t%7.4g\n", transfer[7]);
   fprintf(output_fp, " Maximum =\t%7.4g\n", transfer[6]);
   printf(" Event Ave.  = 	%7.4g Event Sample Var.= 	%7.4g\n", transfer[4], transfer[8]);
   printf(" Minimum  = 	%7.4g\n", transfer[7]);
   printf(" Maximum  = 	%7.4g\n", transfer[6]);
  c_timest(RUNC[3], 19, 1);
   fprintf(output_fp, "RUNC[3]:\n Time Ave. = \t%7.4g Time Sample Var. =\t%7.4g\n", transfer[4], transfer[7]);
   printf("RUNC[3]:\n Time Ave. = 	%7.4g Time Sample Var. = 	%7.4g\n", transfer[4], transfer[7]);
  c_sampst(RUNC[3], 19, 1);
   fprintf(output_fp, " Event Ave. =\t%7.4g Event Sample Var. =\t%7.4g\n", transfer[4], transfer[8]);
   fprintf(output_fp, " Minimum =\t%7.4g\n", transfer[7]);
   fprintf(output_fp, " Maximum =\t%7.4g\n", transfer[6]);
   printf(" Event Ave.  = 	%7.4g Event Sample Var.= 	%7.4g\n", transfer[4], transfer[8]);
   printf(" Minimum  = 	%7.4g\n", transfer[7]);
   printf(" Maximum  = 	%7.4g\n", transfer[6]);
  c_timest(RUNC[4], 20, 1);
   fprintf(output_fp, "RUNC[4]:\n Time Ave. = \t%7.4g Time Sample Var. =\t%7.4g\n", transfer[4], transfer[7]);
   printf("RUNC[4]:\n Time Ave. = 	%7.4g Time Sample Var. = 	%7.4g\n", transfer[4], transfer[7]);
  c_sampst(RUNC[4], 20, 1);
   fprintf(output_fp, " Event Ave. =\t%7.4g Event Sample Var. =\t%7.4g\n", transfer[4], transfer[8]);
   fprintf(output_fp, " Minimum =\t%7.4g\n", transfer[7]);
   fprintf(output_fp, " Maximum =\t%7.4g\n", transfer[6]);
   printf(" Event Ave.  = 	%7.4g Event Sample Var.= 	%7.4g\n", transfer[4], transfer[8]);
